...
class Qnetwork():
    def __init__(self, h_size, rnn_cell, myScope):
        ...
        self.layer1 = tf.layers.dense(self.scalarInput, 3, activation=tf.nn.relu)
        self.layer2 = tf.layers.dense(self.layer1, 3, activation=tf.nn.relu)
        ...
        self.convFlat = tf.reshape(self.layer2, [self.batch_size, self.trainLength, 3])
        ...
        self.Qout = tf.layers.dense(self.layer2, 4, activation=tf.nn.relu)
...
endE = 0.25 #Final chance of random action
...
h_size = 4 #The size of the final convolutional layer before splitting it into Advantage and Value streams.
    ...
    for i in range(num_episodes):
        ...
        while j < max_epLength:
            ...
            if np.random.rand(1) < e or total_steps < pre_train_steps:
                ...
                #                  feed_dict={mainQN.scalarInput: [s], mainQN.trainLength: 1, mainQN.state_in: state,
                #                             mainQN.batch_size: 1})
                ...
                a = sess.run([mainQN.predict], \
                                     feed_dict={mainQN.scalarInput: [s], mainQN.trainLength: 1, mainQN.batch_size: 1})
